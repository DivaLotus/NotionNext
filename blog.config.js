...
const BLOG = {
  AUTHOR: 'Space Hub', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://project.spacehub.art', // 网站地址
  KEYWORDS: 'Notion, 博客,作品集,项目展示', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '2bd4567ee66a4dfeb63427ad36c31654', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  POSTS_PER_PAGE: 99, // post counts per page
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Ming`s Project', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Ming`s Project', // 站点描述，被notion中的页面描述覆盖
